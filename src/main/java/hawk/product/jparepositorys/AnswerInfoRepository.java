...
//	@Query(value = "SELECT new hawk.product.dtos.AnswersDTO.AnswersDTO(answerInfo_Id,qTag,ansValue) FROM answerinfo_answers WHERE qTag IN(:qTags) AND ansValue IN (:values) ", nativeQuery = true) // Status=:status
//	// and
