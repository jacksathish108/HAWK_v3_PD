...
public class ViewInfo implements Serializable {
    ...
    private List<QuestionInfo> applicableQtagMap;

    public List<Object> update(ViewInfo viewInfo) {
        ...
        if (!Objects.equals(this.description, viewInfo.getDescription())) {
            changeHistoryList.add(HawkResources.buildUpdateHistory("description", description, viewInfo.getDescription()));
        ...
        if (!Objects.equals(this.viewCode, viewInfo.getViewCode())) {
        ...
        if (!Objects.equals(this.applicableQtagMap, viewInfo.getApplicableQtagMap())) {
            changeHistoryList.add(HawkResources.buildUpdateHistory("questions", applicableQtagMap, viewInfo.getApplicableQtagMap()));
